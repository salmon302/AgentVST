# SchemaExampleToneShaper (Generated Scaffold)

This directory was generated from `c:\Users\salmo\Documents\GitHub\AgentVST\schema\example_plugin.json` at 2026-04-07 16:51:56Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `SchemaExampleToneShaper`
- `src/SchemaExampleToneShaperDSP.cpp` - starter `processSample` implementation
