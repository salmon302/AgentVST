...
base_dir = "examples/just_intonation_muqarnas/JustIntonationMuqarnas"
os.makedirs(f"{base_dir}/src", exist_ok=True)

plugin_json = {
  "plugin": {
    "name": "JustIntonationMuqarnas",
    "version": "1.0.0",
    "vendor": "AgentVST",
    "category": "Fx"
  },
  "parameters": [
    ...
    {
      "id": "muqarnas_division",
      "name": "Muqarnas Division",
      "type": "float",
      "min": 1.0,
      "max": 1024.0,
      "default": 128.0,
    ...
    {
      "id": "consonance_gravity",
      "name": "Consonance Gravity",
      "type": "float",
      "min": 0.0,
      "max": 100.0,
      "default": 50.0,
...
cmake = """agentvst_add_plugin(
    ...
    PLUGIN_CODE "JIMq"
    SOURCES
        src/JustIntonationMuqarnasDSP.cpp
)
target_include_directories(JustIntonationMuqarnas PRIVATE "/framework/src")
"""
...
with open(f"{base_dir}/src/JustIntonationMuqarnasDSP.cpp", "w") as f:
    f.write(dsp)
