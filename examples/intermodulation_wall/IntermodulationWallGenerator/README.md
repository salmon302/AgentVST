# IntermodulationWallGenerator (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\intermodulation_wall_generator.json` at 2026-04-18 05:28:30Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `IntermodulationWallGenerator`
- `src/IntermodulationWallGeneratorDSP.cpp` - starter `processSample` implementation
