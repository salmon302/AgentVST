# NegativeSpaceDelay (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\negative_space_delay.json` at 2026-04-18 05:36:19Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `NegativeSpaceDelay`
- `src/NegativeSpaceDelayDSP.cpp` - starter `processSample` implementation
