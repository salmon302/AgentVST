# FracturedTachyon (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\fractured_tachyon.json` at 2026-04-18 04:59:30Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `FracturedTachyon`
- `src/FracturedTachyonDSP.cpp` - starter `processSample` implementation
