# AntiLoudnessTransientRestorer (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\anti_loudness_transient_restorer.json` at 2026-04-18 16:13:34Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `AntiLoudnessTransientRestorer`
- `src/AntiLoudnessTransientRestorerDSP.cpp` - starter `processSample` implementation
