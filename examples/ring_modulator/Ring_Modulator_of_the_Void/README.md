# Ring Modulator of the Void (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\ring_modulator_of_the_void.json` at 2026-04-18 04:30:34Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `Ring_Modulator_of_the_Void`
- `src/Ring_Modulator_of_the_VoidDSP.cpp` - starter `processSample` implementation
