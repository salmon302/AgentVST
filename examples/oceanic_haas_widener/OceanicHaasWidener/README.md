# OceanicHaasWidener (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\oceanic_haas_widener.json` at 2026-04-18 14:38:07Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `OceanicHaasWidener`
- `src/OceanicHaasWidenerDSP.cpp` - starter `processSample` implementation
