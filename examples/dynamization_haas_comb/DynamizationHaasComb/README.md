# DynamizationHaasComb (Generated Scaffold)

This directory was generated from `I:\Documents\GitHub\AgentVST\schema\dynamization_haas_comb.json` at 2026-04-18 05:28:47Z.

## Files

- `plugin.json` - validated schema input copied into this directory
- `CMakeLists.txt` - `agentvst_add_plugin` entry for `DynamizationHaasComb`
- `src/DynamizationHaasCombDSP.cpp` - starter `processSample` implementation
